...
class Buffer:
    ...
    def add_data(self, task_id, examples, features, labels=None, logits=None, task_labels=None):
        ...
        for i in range(self.cpt * task_id, self.cpt * task_id + self.cpt):
            ...
            examples_to_add = examples[class_idxs][ipm_idxs].squeeze(dim = 1)
            labels_to_add = labels[class_idxs][ipm_idxs].squeeze(dim = 1)
            logits_to_add = logits[class_idxs][ipm_idxs].squeeze(dim = 1)
